...
async def word_live_set_page_layout(
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_set_page_layout
...
async def word_live_add_header_footer(
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_add_header_footer
...
async def word_live_add_section_break(
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_add_section_break
...
async def word_live_set_paragraph_spacing(
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_set_paragraph_spacing
...
async def word_live_add_bookmark(
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_add_bookmark
