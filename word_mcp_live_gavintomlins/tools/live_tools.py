...
async def word_live_insert_text(
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_insert_text
...
async def word_live_format_text(
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_format_text
...
async def word_live_apply_list(
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_apply_list
...
async def word_live_setup_heading_numbering(
    ...
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_setup_heading_numbering
...
async def word_live_replace_text(
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_replace_text
...
async def word_live_add_table(
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_add_table
...
async def word_live_delete_text(
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_delete_text
...
async def word_live_modify_table(
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_modify_table
    ...
    try:
        from word_mcp_live_gavintomlins.core.word_com import get_word_app, find_document, undo_record
        from word_mcp_live_gavintomlins.core import table_com
...
async def word_live_undo(
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_undo
...
async def word_live_save(
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_save
...
async def word_live_toggle_track_changes(
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_toggle_track_changes
