...
from word_mcp_live_gavintomlins.utils.file_utils import ensure_docx_extension
from word_mcp_live_gavintomlins.core.comments import (
...
async def get_comments_for_paragraph(filename: str, paragraph_index: int) -> str:
    ...
    try:
        ...
        from word_mcp_live_gavintomlins.core.comments import get_comments_for_paragraph as core_get_comments_for_paragraph
