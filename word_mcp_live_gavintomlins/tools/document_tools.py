...
from word_mcp_live_gavintomlins.utils.file_utils import check_file_writeable, ensure_docx_extension, create_document_copy
from word_mcp_live_gavintomlins.utils.document_utils import get_document_properties, extract_document_text, get_document_structure, get_document_xml, insert_header_near_text, insert_line_or_paragraph_near_text
from word_mcp_live_gavintomlins.core.styles import ensure_heading_style, ensure_table_style
...
async def list_available_documents(directory: str = ".") -> str:
    ...
    """
    try:
        from word_mcp_live_gavintomlins.utils.path_safety import validate_path
...
async def merge_documents(target_filename: str, source_filenames: List[str], add_page_breaks: bool = True) -> str:
    ...
    """
    from word_mcp_live_gavintomlins.core.tables import copy_table
...
async def backup_document(filename: str, note: str = None) -> str:
    ...
    """
    import json
    from word_mcp_live_gavintomlins.utils.backup_manager import backup_manager
