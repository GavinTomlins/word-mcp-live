...
from word_mcp_live_gavintomlins.utils.extended_document_utils import get_paragraph_text, find_text, get_highlighted_text
    ...
    try:
        async with get_file_lock(filename):
            ...
            if system == "Windows":
                ...
                if system == "Darwin":
                    try:
                        from word_mcp_live_gavintomlins.core.word_mac import mac_save_as_pdf
