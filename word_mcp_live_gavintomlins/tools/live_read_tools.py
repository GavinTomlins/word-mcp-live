...
from word_mcp_live_gavintomlins.defaults import DEFAULT_AUTHOR
# macOS JXA dispatch
...
async def word_live_take_snapshot(filename: str = None) -> str:
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_get_text
    ...
    try:
        from word_mcp_live_gavintomlins.core.word_com import get_word_app, find_document
...
async def word_live_get_text(filename: str = None) -> str:
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_get_text, mac_get_info, mac_get_page_text
...
async def word_live_get_paragraph_format(
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_get_paragraph_format
...
async def word_live_get_info(filename: str = None) -> str:
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_get_info
...
async def word_live_find_text(
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_find_text
    ...
    from word_mcp_live_gavintomlins.utils.text_safety import reject_control_chars
    try:
...
async def word_live_get_comments(filename: str = None) -> str:
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_get_comments
...
async def word_live_add_comment(
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_add_comment
    ...
    try:
        from word_mcp_live_gavintomlins.core.word_com import get_word_app, find_document, undo_record
...
async def word_live_delete_comment(
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_delete_comment
...
async def word_live_list_revisions(filename: str = None) -> str:
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_list_revisions
...
async def word_live_accept_revisions(
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_accept_revisions
...
async def word_live_reject_revisions(
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_reject_revisions
...
async def word_live_get_page_text(
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_get_page_text
...
async def word_live_diagnose_layout(
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_diagnose_layout
...
async def word_live_set_core_properties(
    ...
    try:
        from word_mcp_live_gavintomlins.core.word_com import (
...
async def word_live_list_open() -> str:
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_live_gavintomlins.core.word_mac import mac_list_open
    ...
    try:
        from word_mcp_live_gavintomlins.core.word_com import get_word_app
