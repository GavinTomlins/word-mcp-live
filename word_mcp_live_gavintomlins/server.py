...
from word_mcp_live_gavintomlins.config import Settings, get_settings
from word_mcp_live_gavintomlins.core.auth import build_token_verifier
from word_mcp_live_gavintomlins.mcp_tools import register_all
...
async def _lifespan(server):
    ...
    from word_mcp_live_gavintomlins.utils.path_utils import install_path_hook
    from word_mcp_live_gavintomlins.utils.save_utils import install_save_hook
