...
Usage::
    ...
    WORD_MCP_API_KEY=sk-your-secret-key python -m word_mcp_live_cheemscheems

    # Explicitly allow no-auth (NOT RECOMMENDED for remote access):
    WORD_MCP_INSECURE=true python -m word_mcp_live_cheemscheems
...
from word_mcp_live_cheemscheems.config import Settings
